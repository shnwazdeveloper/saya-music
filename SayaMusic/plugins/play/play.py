...
from SayaMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from SayaMusic.core.call import StreamController
from SayaMusic.utils import seconds_to_min, time_to_seconds
from SayaMusic.utils.channelplay import get_channeplayCB
from SayaMusic.utils.decorators.language import languageCB
from SayaMusic.utils.decorators.play import PlayWrapper
from SayaMusic.utils.errors import capture_err, capture_callback_err
from SayaMusic.utils.formatters import formats
from SayaMusic.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from SayaMusic.utils.logger import play_logs
...
@app.on_callback_query(filters.regex("SayaPlaylists") & ~BANNED_USERS)
@languageCB
@capture_callback_err
