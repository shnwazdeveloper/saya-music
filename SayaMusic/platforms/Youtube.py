...
from SayaMusic.utils.database import is_on_off
from SayaMusic.utils.downloader import yt_dlp_download
from SayaMusic.utils.errors import capture_internal_err
from SayaMusic.utils.formatters import time_to_seconds
from SayaMusic.utils.tuning import YTDLP_TIMEOUT, YOUTUBE_META_MAX, YOUTUBE_META_TTL
        ...
        try:
            ...
            def _both_failed(details: str) -> ValueError:
                return ValueError(
                    ...
                    f"  1. youtubesearchpython error: {search_error}\n"
                    f"{details}"
                )
